...
import Express from "@/app/about/_icons/Express";
import MongoDb from "@/app/about/_icons/MongoDb";
  ...
  return (
    <section className="mt-10 flex flex-col md:grid md:grid-cols-5 md:grid-rows-5 gap-4 px-4 lg:px-20 ">
      ...
      <SkillBox cols={3} rows={3} className="flex flex-col gap-2">
        <h2 className="text-darkBlue text-xl  font-bold underline">O mně:</h2>
        ...
        <ul>
          <li>
            <p className="text-darkBlue">
              <span className="text-darkBlue font-bold">HTML a CSS</span> - 5
              let
            </p>
          </li>
          <li>
            <p className="text-darkBlue">
              <span className="text-darkBlue font-bold">Next.js</span> - 5
              měsíců
            </p>
          </li>
        </ul>
        ...
        <p className="text-darkBlue">
          Jsem sportovně založený člověk s pozitivním nastavením mysli. Pokud mě
          práce baví a dává mi smysl, nemám problém u ní trávit hodiny volného
          času. Jako můj hlavní koníček považuji výrobu designových koberečků na
          zakázku. Volný čas rád trávím jakoukoli sportovní aktivitou nebo s
          přáteli.
        </p>
      </SkillBox>
      ...
      <SkillBox cols={2} rows={1} className="lg:col-span-1">
        <h2 className="text-darkBlue text-xl font-bold underline ">Hobby</h2>
